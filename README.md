...
- WebGPU para acelerar la IA cuando el teléfono lo permite.
...
## Importante
El primer uso descarga el modelo al navegador. El modelo ocupa alrededor de 1.6 GB de memoria/recursos según la variante; el teléfono necesita suficiente memoria y un navegador compatible con WebGPU.
...
## Si aparece "WebGPU no disponible"
Prueba Chrome actualizado. Si tu dispositivo/navegador no ofrece WebGPU, esta versión no puede ejecutar el modelo localmente. No se incluye una API de pago como respaldo, para mantener el proyecto $0.
